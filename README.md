...
Also a techdemo that demonstrates interaction with the api, including authed api calls (testchat), image generation (wallpaper) and translation (text in dashboard).
